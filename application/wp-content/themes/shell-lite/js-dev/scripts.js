/*!
 * Shell JavaScript Library v1.0.4
 */
 ...
 */
if (jQuery.browser.msie && jQuery.browser.version <= 6) jQuery('<div class="msie">' + '<a href="http://windows.microsoft.com/en-us/internet-explorer/downloads/ie" title="Click here to update" target="_blank">  Your browser is no longer supported. Click here to update...</a> </div>').appendTo(document.body);
